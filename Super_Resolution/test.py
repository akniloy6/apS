...
parser.add_argument(
    "--input_dir",
    default="./Datasets/test/realSR/",
    type=str,
    help="Directory of validation images",
)
parser.add_argument(
    "--result_dir", default="./results/realSR/", type=str, help="Directory for results"
)
parser.add_argument(
    "--scale", default="x4", type=str, help="Scale factor for super-resolution"
)
