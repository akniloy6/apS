...
for data in args.data.split("-"):
    if data == "train":
        ...
        shutil.unpack_archive(
            "Datasets/Downloads/DPDD/train.zip", "Datasets/Downloads/DPDD"
        )
        ...
        shutil.unpack_archive(
            "Datasets/Downloads/DPDD/val.zip", "Datasets/Downloads/DPDD"
        )
    ...
    if data == "test":
        ...
        shutil.move(
            os.path.join("Datasets", "DPDD"), os.path.join("Datasets", "test", "DPDD")
        )
